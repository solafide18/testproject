            ...
            for (int i = (sheet.FirstRowNum + 1); i <= sheet.LastRowNum; i++) //Read Excel File
            {
                ...
                try
                {
                    ...
                    if (record != null)
                    {
                        ...
                        record.modified_on = DateTime.Now;
                        kol++;
                        record.sampling_template_name = PublicFunctions.IsNullCell(row.GetCell(1)); kol++;
                    ...
                    else
                    {
                        ...
                        record.sampling_template_code = PublicFunctions.IsNullCell(row.GetCell(0)); kol++;
                        record.sampling_template_name = PublicFunctions.IsNullCell(row.GetCell(1)); kol++;
                        record.is_active = PublicFunctions.BenarSalah(row.GetCell(2)); kol++;
            ...
            for (int i = (sheet.FirstRowNum + 1); i <= sheet.LastRowNum; i++) //Read Excel File
            {
                ...
                try
                {
                    ...
                    if (record != null)
                    {
                        ...
                        record.remark = PublicFunctions.IsNullCell(row.GetCell(3)); kol++;
                        record.is_active = PublicFunctions.BenarSalah(row.GetCell(4)); kol++;
