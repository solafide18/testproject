            ...
            for (int i = (sheet.FirstRowNum + 1); i <= sheet.LastRowNum; i++) //Read Excel File
            {
                ...
                try
                {
                    ...
                    if (record != null)
                    {
                        ...
                        record.vehicle_make = PublicFunctions.IsNullCell(row.GetCell(3)); kol++;
                        record.vehicle_model = PublicFunctions.IsNullCell(row.GetCell(4)); kol++;
                        record.vehicle_model_year = PublicFunctions.Bulat(row.GetCell(5)); kol++;
                        record.vehicle_manufactured_year = PublicFunctions.Bulat(row.GetCell(6)); kol++;
