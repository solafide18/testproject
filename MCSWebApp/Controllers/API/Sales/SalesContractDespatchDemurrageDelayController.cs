        ...
        public async Task<object> DataGrid(DataSourceLoadOptions loadOptions, string demurrageTermId)
        {
            try
            {
                return await DataSourceLoader.LoadAsync(
                    dbContext.vw_sales_contract_despatch_demurrage_delay.Where(o => o.organization_id == CurrentUserContext.OrganizationId && o.sales_contract_despatch_demurrage_id == demurrageTermId), 
                    loadOptions);
            }
            catch (Exception ex)
            {
