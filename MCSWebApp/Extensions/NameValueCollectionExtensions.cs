...
namespace MCSWebApp.Extensions
{
    public static class NameValueCollectionExtensions
    {
        ...
        public static DTRequest ToDataTablesRequest(this NameValueCollection formCollection)
        {
        ...
        public static Select2Request ToSelect2Request(this NameValueCollection formCollection)
        {
            ...
            try
            {
                foreach (var key in formCollection.AllKeys)
                {
                    if (key.ToLower() == "term")
                    {
                        result.term = formCollection[key];
                    }
                    else if (key.ToLower() == "_type")
                    {
                        result._type = formCollection[key];
                    }
                    ...
                    {
                        if (int.TryParse(formCollection[key], out int page))
                        {
                            result.page = page;
                        }
                    }
                    ...
                    {
                        result.keyValues.Add(key, formCollection[key]);
                    }
                }
            }
            catch (Exception ex)
