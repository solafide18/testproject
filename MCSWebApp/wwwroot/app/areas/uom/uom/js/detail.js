$(document).ready(function () {
    ...
    var basePath = "/UOM/UOM";
    var apiPath = "/api" + basePath;

    $("#UOMCategory").select2({
        ajax:
        {
            url: "/api/UOM/UOMCategory/select2",
            headers: {
        ...
        $('#uom_category_id').val(data.id);
        $('#uom_category_name').val(data.text);
    });
            ...
            $.ajax({
                ...
                if (result !== null) {
                    if (result.success && result.data !== null) {
                        ...
                        $('#uom_category_id').val(result.data.uom_category_id);
                        $('#uom_category_name').val(result.data.uom_category_name);

                        $('#UOMCategory').append(new Option(
                            $('#uom_category_name').val(),
                            $('#uom_category_id').val(), true, true)
                        ).trigger('change');
                    }
