$(function () {
    ...
    $("#grid").dxDataGrid({
        ...
        columns: [
            ...
            {
                dataField: "alias16",
                caption: "Alias16 Header Analytes",
                dataType: "string",
                visible: false,
                formItem: {
                    editorOptions: {
            ...
            {
                dataField: "alias18",
                caption: "Alias18 Certificate Number",
                dataType: "string",
                visible: false,
                formItem: {
                    editorOptions: {
            ...
            //            recordId = e.row.data.id;
            //            $.ajax({
            //                url: url + "/RequestApproval/" + encodeURIComponent(recordId),
            //                type: 'GET',
            //                headers: {
            //                    "Authorization": "Bearer " + token
            //                }
            ...
            //            //console.log(salesInvoiceApprovalData);

            //            //salesInvoiceApprovalData.sales_invoice_id = e.row.data.id;
            //            //showApprovalPopup();
            //        }
            //    }]
            //},
