$(document).ready(function () {
    ...
    var basePath = "/Material/Product";
    var apiPath = "/api" + basePath;

    $("#ProductCategory").select2({
        ajax:
        {
            url: "/api/Material/ProductCategory/select2",
            headers: {
        ...
        $('#product_category_name').val(data.text);
    });
            ...
            $.ajax({
                ...
                if (result !== null) {
                    if (result.success && result.data !== null) {
                        ...
                        $('#product_category_id').val(result.data.product_category_id);
                        $('#product_category_name').val(result.data.product_category_name);

                        $('#ProductCategory').append(new Option(
                            $('#product_category_name').val(),
                            $('#product_category_id').val(), true, true)
                        ).trigger('change');
                    }
