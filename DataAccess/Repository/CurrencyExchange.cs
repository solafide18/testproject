...
{
    public partial class currency_exchange : IEntity
    {
        ...
        static currency_exchange()
        {
            ...
            DefaultViewType = typeof(vw_currency_exchange);
            ...
            DefaultViewOrders = new Dictionary<string, string>
            {
                ...
                { "start_date", "DESC" },
                { "source_currency_name", "ASC" },
                { "target_currency_name", "ASC" }
            };
